...
// Open Source Software; you can modify and/or share it under the terms ofgit commit --amend -m "New commit message"
...
public class RobotContainer {
    ...
    private final SwerveRequest.FieldCentric drive = new SwerveRequest.FieldCentric()
            .withDeadband(MaxSpeed * 0.2).withRotationalDeadband(MaxAngularRate * 0.2) // Add a (2)0% deadband
